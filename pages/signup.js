        ...
        <div className="min-h-screen bg-dark-bg flex items-center justify-center px-4 relative overflow-hidden">
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label className="text-gray-400 text-xs uppercase tracking-wider font-bold mb-2 block">Jméno</label>
                        <input
                            type="text"
                            required
                ...
                <div className="mt-6 text-center text-gray-400 text-sm">
                    Už máš účet?{' '}
                    <Link href="/login">
                        <span className="text-accent-primary font-bold cursor-pointer hover:underline">Přihlas se</span>
                    </Link>
                </div>
            </motion.div>
        </div>
